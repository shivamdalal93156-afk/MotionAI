...
var _log = new File('C:/Users/SHIVAM/Desktop/motionai/backend/templates/DynamicTypographyTitlesPack/_scan.log');
_log.open('w');
function L(msg) { _log.writeln(msg); }

try {
  L('=== MOTIONAI COMPLETE SCAN v4.0 ===');
  L('template: DynamicTypographyTitlesPack');
  L('aep: C:/Users/SHIVAM/Desktop/motionai/backend/templates/DynamicTypographyTitlesPack/DynamicTypographyTitlesPack.aep');
  L('scanned_at: ' + new Date().toString());
  L('');

  var f = new File('C:/Users/SHIVAM/Desktop/motionai/backend/templates/DynamicTypographyTitlesPack/DynamicTypographyTitlesPack.aep');
  app.open(f);
...
var srcF = new File('C:/Users/SHIVAM/Desktop/motionai/backend/templates/DynamicTypographyTitlesPack/_scan.log');
var dstF = new File('C:/Users/SHIVAM/Desktop/motionai/backend/templates/DynamicTypographyTitlesPack/scan_result.txt');
srcF.open('r');
dstF.open('w');
